...
const Signup = (props) => {
  ...
  const slides = [
    ...
    },
    {
     ...
     <>
      <div className="signupform">
        ...
        <Input text='Password' value={password} setValue={setPassword} type='password'/>
    ...
    },
    {
      ...
      content: <Plantable active={active} setActive={setActive} handleSignup={handleSignup}/>
    }
  ]
  const clearErrors = () => {
    setErrors({
    ...
    if(slide.slide1) {
      return (
        <div className="slidesign flex slide1">
          ...
          <span>STEP <strong>1 </strong>OF <strong>{slides.length - 1}</strong></span>
          <h2>{slide.title}</h2>
      ...
      return (
        <div className="slidesign flex benefits">
          ...
          <span>STEP <strong>{slide.step}</strong> OF <strong>{slides.length - 1}</strong></span>
          <h2>{slide.title}</h2>
